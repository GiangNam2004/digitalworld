...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="" class="button">Xác Nhận Đơn Hàng</a>

            <p>Thông tin chi tiết về đơn hàng sẽ được cập nhật sau khi bạn xác nhận. Bạn có thể theo dõi tình trạng đơn hàng của mình trong tài khoản.</p>
            <p>Cảm ơn bạn đã mua sắm tại Digital World!</p>
        </div>

        <div class="footer">
            <p>Nếu bạn có bất kỳ câu hỏi nào, vui lòng liên hệ với chúng tôi qua email <a href="mailto:support@digitalworld.com">support@digitalworld.com</a>.</p>
